...
urlpatterns = [
    ...
    path('users/<int:pk>/retrieve/', views.UserRetrieveAPIView.as_view(), name='user-retrieve'),
    path('users/<int:pk>/update/', views.UserUpdateAPIView.as_view(), name='user-update'),
    path('users/<int:pk>/destroy/', views.UserDestroyAPIView.as_view(), name='user-destroy')
]
